<?php
/*
GitHub URI: https://github.com/mustardBees/cmb-field-select2
...
function pw_select2_enqueue() {
	wp_enqueue_script( 'pw-select2-field-js', get_template_directory_uri() .  '/lib/cmb_extension/js/select2/select2.min.js', array( 'jquery-ui-sortable' ), '3.5.1' );
	wp_enqueue_script( 'pw-select2-field-init', get_template_directory_uri() . '/lib/cmb_extension/js/select2-init.js', array( 'pw-select2-field-js' ), '2.0.4' );
	wp_enqueue_style( 'pw-select2-field-css', get_template_directory_uri() . '/lib/cmb_extension/js/select2/select2.css', array(), '3.5.1' );
	wp_enqueue_style( 'pw-select2-field-mods', get_template_directory_uri() . '/lib/cmb_extension/css/select2.css', array(), '2.0.4' );
}
