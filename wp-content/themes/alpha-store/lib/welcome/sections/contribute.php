...
<div id="contribute" class="alpha-store-tab-pane">
	...
	<div class="alpha-store-tab-pane-half alpha-store-tab-pane-first-half">
		...
		<p><strong><?php esc_html_e( 'Found a bug? Want to contribute with a fix or create a new feature?','alpha-store'); ?></strong></p>

		<p><?php esc_html_e( 'Support fourm is the place to go!','alpha-store' ); ?></p>

		<p>
			<a href="<?php echo esc_url( 'http://support.themes4wp.com/' ); ?>" class="contribute-button button button-primary"><?php printf( esc_html__( '%s support forum', 'alpha-store' ), 'Alpha Store' ); ?></a>
		</p>
