			...
			<div class="alpha-store-child-theme-details">
				...
				<?php } else { ?>
					<div class="theme-details active">
						...
						<a class="button button-secondary customize right" target="_blank" href="<?php echo esc_url( get_site_url(). '/wp-admin/customize.php' ); ?>"><?php esc_html_e( 'Customize','alpha-store'); ?></a>
						<div class="alpha-store-clear"></div>
					</div>
				<?php } ?>
			</div>
			...
			<div class="alpha-store-child-theme-details">
				<?php if ( 'Giga Store' != $current_theme['Name'] ) { ?>
					<div class="theme-details">
						...
						<a href="<?php echo esc_url( 'http://themes4wp.com/theme/giga-store/' ); ?>" target="_blank" class="button button-primary install right"><?php printf( __( 'Install %s now', 'alpha-store' ), '<span class="screen-reader-text">Giga Store</span>' ); ?></a>
